...
<meta http-equiv="refresh" content="0; url=http://localhost/ABUOCR/Files/imp.py" />
 <!--Import jQuery before materialize.js-->
  ...
  <div class="progress">
	  ...
	  if (!file_exists('matlab_called')) {   
		...
		#echo "<script type=\"text/javascript\">window.open('http://localhost/ABUOCR/Files/processing.php');</script>";
